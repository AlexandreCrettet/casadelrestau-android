...
object sampleRestau {
    ...
    fun getSample(): List<MiamzReqPlaceData> {
        ...
        val test = MiamzReqPlaceData(0, "nom", 12.0, 12.0, "path", "path2", "path",
            "path", "path", "Categorie", "User email", "12:30 PM - 14:00",user )
        val test2 = MiamzReqPlaceData(1, "nom2", 12.0, 12.0, "path", "path2", "path",
            "path", "path", "Categorie2", "User email2","12:30 PM - 14:00", user )
        val test3 = MiamzReqPlaceData(2, "nom3", 12.0, 12.0, "path", "path2", "path",
